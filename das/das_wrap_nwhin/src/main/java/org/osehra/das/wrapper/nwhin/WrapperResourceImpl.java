...
@Path("/")
@Scope("request")
public class WrapperResourceImpl extends ComponentImpl implements
		MessageReceiver<UriInfo, Object>, WrapperResource {

	private static final Log LOG = LogFactory.getLog(WrapperResourceImpl.class);
