...
public class C32DocumentLogic implements IC32DocumentLogic, Serializable{
	...
	public String filterDocument (String document) {
		document = filterProblemList(document);
		document = filterLabs(document);
		return document;
	}

	protected String filterProblemList (String document) {
	...
	protected String filterLabs (String document) {
		boolean debugging = LOG.isDebugEnabled();
		//Variable represents # of days delay on results.
		int LabDelayDays = 7;
