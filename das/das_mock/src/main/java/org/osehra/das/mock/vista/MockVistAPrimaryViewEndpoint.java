...
public class MockVistAPrimaryViewEndpoint implements
		...
		try {
			...
			if ("1012581676V377802".contains((String) obj)) {
				final org.springframework.core.io.Resource resource = this.applicationContext
						.getResource("classpath:org/osehra/das/mock/endpoint/vista/mvi/MPI_RETURN_PRIMARY_VIEW_DATA.txt");
				final String primaryViewData = FileUtil.getResource(resource);
				return primaryViewData;
			} else if ("1111111111V111111".equals(obj)) {
				final org.springframework.core.io.Resource resource = this.applicationContext
						.getResource("classpath:org/osehra/das/mock/endpoint/vista/mvi/MPI_RETURN_PRIMARY_VIEW_DATA_MPIPATIENT_ONE.txt");
				final String extendedViewData = FileUtil.getResource(resource);
				return extendedViewData;
			} else if ("2222222222V222222".equals(obj)) {
				final org.springframework.core.io.Resource resource = this.applicationContext
						.getResource("classpath:org/osehra/das/mock/endpoint/vista/mvi/MPI_RETURN_PRIMARY_VIEW_DATA_MPIPATIENT_ONE_2.txt");
				final String extendedViewData = FileUtil.getResource(resource);
				return extendedViewData;
