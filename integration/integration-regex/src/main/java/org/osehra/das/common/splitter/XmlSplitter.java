...
public class XmlSplitter implements Splitter<Document, List<Document>> {
	 ...
	 * @uml.associationEnd  
	 */
	private org.osehra.das.common.transformer.Transformer<String, Document> stringToXML;

	/**
	 * Set the flag whether to add the input message to the output.
	 * @param theAddInput  true to add the input to the output, false otherwise
	 * @uml.property  name="addInput"
	 */
	 ...
	 */
	@Required
	public final void setNodeToXML(
	 ...
	 */
	@Override
	public final List<Document> split(final Document modelDoc)
			throws SplitterException {
