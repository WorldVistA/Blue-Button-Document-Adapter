...
import org.osehra.das.common.selector.xml.XPathExpressionSelector;
...
public class StringXPathExpressionResourceResolver extends
	...
	/**
	 * The resources with a boolean XPathExpression as the key and the resource as the value. If the XPath expression evaluates to true, then the resource will be returned.
	 * @uml.property  name="resources"
	 * @uml.associationEnd  qualifier="value:java.lang.String org.springframework.core.io.Resource"
	 */
	 ...
	 */
	@Override
	public final Resource resolve(final Document sourceData)
			throws ResolverException {
		try {
	 ...
	 */
	@Required
	public final void setResources(final Map<String, Resource> theResources) {
