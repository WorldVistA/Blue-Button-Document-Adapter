 ...
 * the message using XPath exrpessions.
 * 
 * @author Julian Jewel
 */
public class XmlPropertyManager implements CustomPropertyManager {
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="javax.xml.xpath.XPathExpression" qualifier="key:java.lang.String javax.xml.xpath.XPathExpression"
	 */
	 ...
	 */
	@Override
	public final Map<String, Object> getProperties(final Object object) {
	 ...
	 */
	@Required
	public final void setpropertyExpressions(
