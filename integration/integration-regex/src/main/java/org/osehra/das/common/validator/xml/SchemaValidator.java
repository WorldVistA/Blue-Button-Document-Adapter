...
public class SchemaValidator implements
		org.osehra.das.common.validator.Validator<Document> {
	/**
	 * The error handler.
	 ...
	 * @param theErrorHandler  the error handler
	 * @uml.property  name="errorHandler"
	 */
	public final void setErrorHandler(final ErrorHandler theErrorHandler) {
		this.errorHandler = theErrorHandler;
	}

	/**
	 * Set the schema factory.
	 * @param theFactory  the schema factory
	 * @uml.property  name="factory"
	 */
	@Autowired
	public final void setFactory(final SchemaFactory theFactory) {
