...
public class RootNameResourceResolver implements Resolver<Document, Resource> {
	 ...
	 * @uml.associationEnd  qualifier="rootElementName:java.lang.String org.springframework.core.io.Resource"
	 */
	 ...
	 */
	@Override
	public final Resource resolve(final Document message) {
