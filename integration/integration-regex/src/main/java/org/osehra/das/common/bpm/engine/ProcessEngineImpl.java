...
import org.osehra.das.common.bpm.activity.Reply;
import org.osehra.das.common.bpm.activity.Transition;
import org.osehra.das.common.bpm.persistence.PersistentContext;
import org.osehra.das.common.bpm.state.Continue;
import org.osehra.das.common.bpm.state.Persisted;
import org.osehra.das.common.bpm.state.Start;
import org.osehra.das.common.bpm.state.State;
...
public class ProcessEngineImpl extends AbstractRuleEngine<Object> implements
	...
	/**
	 * Persistence Context reference to restore the process context by correlation id.
	 ...
	 */
	public final Object continueProcess(final Continue state,
	 ...
	 */
	public final Object processException(final State state,
	 ...
	 */
	public final Object processReply(final ProcessContext context) {
	 ...
	 */
	@Override
	public final Object processRequest(final Object source)
			throws ProcessException {
		try {
	 ...
	 */
	public final Object restoreProcess(final Persisted state,
			final Object source) throws ActivityException {
	...
	/**
	 * Set the bean factory. This method is executed by the Spring container to set the bean factory.
	 * @param theBeanFactory  the bean factory will be set by Spring
	 * @uml.property  name="beanFactory"
	 */
	@Override
	public final void setBeanFactory(final BeanFactory theBeanFactory) {
	 ...
	 */
	@Required
	public final void setStateResolvers(
	 ...
	 */
	public final Object startProcess(final Start state, final Object source)
			throws ActivityException {
