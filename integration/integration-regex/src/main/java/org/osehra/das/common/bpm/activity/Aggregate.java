...
public class Aggregate extends TransitionImpl {
	...
	/**
	 * Flatten arrays. If there are multiple arrays or array within arrays then flatten all of the documents into one array.
	...
	/**
	 * Splitter is used if the aggregated result has to be split again or each document in the array is split and aggregated.
	...
	/**
	 * Set the boolean flatten arrays. If true, then the arrays will be flattened. False, would just aggregate all inputs into a list.
	 * @param theFlattenArrays  boolean true of false
	 * @uml.property  name="flattenArrays"
	 */
	public final void setFlattenArrays(final boolean theFlattenArrays) {
		this.flattenArrays = theFlattenArrays;
	}

	/**
	 * Set the boolean remove empty flag.
	 * @param theRemoveEmpty  true if the empty elements have to be removed in an array.
	 * @uml.property  name="removeEmpty"
	 */
	public final void setRemoveEmpty(final boolean theRemoveEmpty) {
