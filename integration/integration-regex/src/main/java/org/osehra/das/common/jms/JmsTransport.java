package org.osehra.das.common.jms;
...
public class JmsTransport {
	 ...
	 */
	public final Object receive(final Object source) {
	 ...
	 * @return the received message
	 */
	public final Object selectedReceive(final String theSelector) {
	 ...
	 * @return the object
	 */
	public final Object send(final Destination dest, final Object object) {
	 ...
	 * @return the object
	 */
	public final Object send(final Object object) {
		if (NullChecker.isNotEmpty(this.messagePostProcessor)) {
	 ...
	 * @param theJmsTemplate  the jms template
	 * @uml.property  name="jmsTemplate"
	 */
	@Required
	public final void setJmsTemplate(final JmsTemplate theJmsTemplate) {
		this.jmsTemplate = theJmsTemplate;
	}

	/**
	 * Set the message post processor.
	 * @param theMessagePostProcessor  the message post processor
	 * @uml.property  name="messagePostProcessor"
	 */
	public final void setMessagePostProcessor(
