...
public class LinkedTransform extends AbstractTransform {
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="org.osehra.das.common.transformer.xsl.XSLTransformer"
	 */
	 ...
	 */
	@Required
	public final void setTransformers(final List<XSLTransformer> theTransformers) {
