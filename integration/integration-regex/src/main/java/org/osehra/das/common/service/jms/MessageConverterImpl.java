...
import org.osehra.das.common.property.CustomPropertyManager;
...
public class MessageConverterImpl implements MessageConverter {
	...
	/**
	 * The from message type will convert any object to XML, Bytes or Object to construct a JMS message type. The default value is BYTES and Jms Byte messages are constructed.
	...
	/**
	 * The to message type will convert any object to the appropriate Jms message type. The default value is BYTES.
	 ...
	 * @param theCleanExtended  true to clean the string, false otherwise
	 * @uml.property  name="cleanExtended"
	 */
	 ...
	 */
	public final void setCustomPropertyManagers(
	 ...
	 * @param theFromMessageType  the from message type
	 * @uml.property  name="fromMessageType"
	 */
	public final void setFromMessageType(final MessageType theFromMessageType) {
	 ...
	 */
	public final void setFromTransformer(
	 ...
	 */
	@Required
	public final void setMessageToObject(
	 ...
	 */
	@Required
	public final void setMessageToString(
	 ...
	 */
	@Required
	public final void setMessageToXML(
	 ...
	 * @param theToMessageType  the to message type
	 * @uml.property  name="toMessageType"
	 */
	public final void setToMessageType(final MessageType theToMessageType) {
	 ...
	 */
	public final void setToTransformer(
