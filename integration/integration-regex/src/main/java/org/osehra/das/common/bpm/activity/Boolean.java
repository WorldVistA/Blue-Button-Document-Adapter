...
public class Boolean extends AbstractActivity {
	...
	/**
	 * XPath expression to determine whether its a failure or success. Has to be a boolean expression.
	 ...
	 */
	public final void setFailure(final Activity<ProcessContext> theFailure) {
	 ...
	 */
	public final void setSuccess(final Activity<ProcessContext> theSuccess) {
