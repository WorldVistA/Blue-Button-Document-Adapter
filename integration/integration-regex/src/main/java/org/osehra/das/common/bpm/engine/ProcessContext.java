...
public class ProcessContext implements Serializable {
	...
	/**
	 * The current activity name - needed to restore the process and call an activity. This variable is used when the persisted context is restored and the activity needs to continue.
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" elementType="java.lang.Object" qualifier="property:java.lang.String java.lang.Object"
	 */
	...
	/**
	 * Get the current activity name. The current activity being executed is set in the context.
	 ...
	 */
	public final Object[] getSource(final String input) {
		Object[] sources = null;
	 ...
	 */
	public final void put(final String property, final Object source) {
		Assert.assertNotEmpty(property,
	 ...
	 * @param theCurrentActivityName  the current activity name
	 * @uml.property  name="currentActivityName"
	 */
	public final void setCurrentActivityName(final String theCurrentActivityName) {
		this.currentActivityName = theCurrentActivityName;
	}

	public final void setProperties(final Hashtable<String, Object> table) {
