...
public class Transform extends AbstractTransform {
	 ...
	 * @uml.property name="splitInputList"
	 */
	public void setSplitInputList(final boolean flag) {
	 ...
	 * 
	 * @param theXSLTransformer
	 *            the XSL transformer reference
	 * @uml.property name="transformer"
	 */
	@Required
	public void setTransformer(final XSLTransformer theXSLTransformer) {
