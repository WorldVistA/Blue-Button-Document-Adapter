...
public class XPathUtil {
	...
	public static String getFieldByXPathFunc(final Document doc, final String path)
	            throws XPathException {

		String fieldValue = "";
	    try {
	    	fieldValue = XPathAPI.eval(doc, path).toString();
	    } catch (final TransformerException e2) {
	    	throw new XPathException(e2);
	    }
	    return fieldValue;
    ...
    public static String getCommentFieldByPath(final Document doc, final String path)
            throws XPathException {
