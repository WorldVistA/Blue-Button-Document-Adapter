...
public class XPathExpressionSelector implements Selector<Document, Object> {
	 ...
	 *
	 * @param type
	 *            - The DOM type. Typically a value of the XPathConstants class.
	 *            XPathContants.STRING - returns a value of class
	 *            java.lang.String. XPathConstants.BOOLEAN - returns a value of
	 *            class java.lang.Boolean. XPathConstants.NODE - returns a value
	 *            of class org.w3c.dom.Node. XPathConstants.NODESET - returns a
	 *            value of class org.w3c.dom.NodeList.
	 * @uml.property name="returnType"
	 */
	@Required
