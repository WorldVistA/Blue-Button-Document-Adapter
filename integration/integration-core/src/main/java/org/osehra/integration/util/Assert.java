...
public class Assert {
	 ...
	 */
	public static void assertArraySize(final Object object,
	 ...
	 *            the exception message
	 */
	public static void assertEmpty(final Object object,
	 ...
	 *            the objects
	 */
	public static void assertEmptyAnd(final String message,
	 ...
	 *            the objects
	 */
	public static void assertEmptyOr(final String message,
			final Object... objects) {
		for (final Object object : objects) {
	 ...
	 */
	public static void assertInstance(final Object object,
			final Class<?> clazz) {
	 ...
	 */
	public static void assertInstanceOr(final Object object,
			final Class<?>... clazzes) {
		if (clazzes == null) {
	 ...
	 */
	public static void assertNonEmptyAnd(final String message,
			final Object... objects) {
		for (final Object object : objects) {
	 ...
	 *            the exception message
	 */
	public static void assertNonEmptyArray(final Object object,
			final String message) {
		if (object == null) {
			throw new RuntimeException(message);
		}
	 ...
	 *            the array of objects
	 */
	public static void assertNonEmptyOr(final String message,
			final Object... objects) {
		for (final Object object : objects) {
			if (NullChecker.isNotEmpty(object)) {
				return;
	 ...
	 *            the message
	 */
	public static void assertNotEmpty(final Object object,
			final String message) {
		if (NullChecker.isEmpty(object)) {
			throw new RuntimeException(message);
		}
